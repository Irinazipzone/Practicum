...
| [Прогнозирование оттока клиентов](forecasting_customer_churn) |Разработка системы предсказания отказа от брони | *Pandas, Matplotlib, Seaborn, NumPy, Scikit-learn, Imbalanced-learn, Phik, Pipeline* |
